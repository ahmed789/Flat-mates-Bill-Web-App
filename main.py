...
class BillForm(Form):
    ...
    period = StringField("Bill Period", default='june2022')

    name1 = StringField("Name: ", default='ahmed')
    days_in_house1 = StringField("Days in the house: ", default=12)

    name2 = StringField("Name: ", default='hassan')
